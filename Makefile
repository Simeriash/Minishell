...
SRCS = $(SRC_DIR)/minishell.c \
	   ...
	   $(BUILTINS_DIR)/export/export_in_order_utils.c $(BUILTINS_DIR)/export/export_utils1.c \
	   $(BUILTINS_DIR)/export/ft_export.c $(BUILTINS_DIR)/export/export_helpers1.c \
	   $(SRC_DIR)/exec/execute_cmd.c $(SRC_DIR)/exec/executor.c $(SRC_DIR)/exec/exec_cmd_utils.c \
	   $(SRC_DIR)/exec/find_exec.c $(SRC_DIR)/exec/find_exec_helpers.c $(SRC_DIR)/exec/make_env_array.c \
	   $(SRC_DIR)/exec/handle_builtin.c \
